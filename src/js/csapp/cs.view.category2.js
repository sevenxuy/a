define(function(require, exports, module) {
  ...
  $.widget('cs.category', {
    options: {
      //getcatelist: '/udata/mis/getcatelist?app=flyflow',
    ...
    _create: function() {
      this.render(this.options.getcatelist);
      this._bindEvents();
    },
    render: function(getcatelist) {
      var self = this;
      $.ajax(getcatelist).done(
        function(data) {
          var lists = data.data,
            h = [];
